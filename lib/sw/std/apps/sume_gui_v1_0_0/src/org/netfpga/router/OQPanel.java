...
//        buttons[NFDeviceConsts.OQ_INITIALIZE_OQ_BIT_NUM] = this.resetOQButton;
        ctrlRegGrp = new ControlRegGroup(nf2, NFDeviceConsts.SUME_OUTPUT_QUEUES_0_RESET/*XPAR_NF10_BRAM_OUTPUT_QUEUES_0_RESET_CNTRS+index*512*/,
                                          buttons, invert);
//
...
//                oqByteSizeSliderCtrl.updateFromRegs();
    ...
    private void setupStatsTable(NFDevice nf2, int index) {
        ...
        index = index* 28/*32*/;
        aAddresses[0] = NFDeviceConsts.SUME_OUTPUT_QUEUES_0_PKTSTOREDPORT0 + index;
        aAddresses[1] = NFDeviceConsts.SUME_OUTPUT_QUEUES_0_BYTESSTOREDPORT0 + index;
        aAddresses[2] = NFDeviceConsts.SUME_OUTPUT_QUEUES_0_PKTREMOVEDPORT0 + index;
        aAddresses[3] = NFDeviceConsts.SUME_OUTPUT_QUEUES_0_BYTESREMOVEDPORT0 + index;
        aAddresses[4] = NFDeviceConsts.SUME_OUTPUT_QUEUES_0_PKTDROPPEDPORT0 + index;
        aAddresses[5] = NFDeviceConsts.SUME_OUTPUT_QUEUES_0_PKTINQUEUEPORT0 + index;
        aAddresses[6] = NFDeviceConsts.SUME_OUTPUT_QUEUES_0_BYTESDROPPEDPORT0 /* probably wrong!!!!!*/ + index;
