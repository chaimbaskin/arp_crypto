...
public class InterfacePortConfigTableModel extends AbstractTableModel {
    ...
    public InterfacePortConfigTableModel(NFDevice nf2){
        ...
        /* port mac addresses */
        long[] addresses = {
/*                NFDeviceConsts.SUME_NF_10G_INTERFACE0_HIGHADDR,//XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_0_HIGH,
                NFDeviceConsts.SUME_NF_10G_INTERFACE0_BASEADDR,//XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_0_LOW,
                NFDeviceConsts.SUME_NF_10G_INTERFACE1_HIGHADDR,//XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_1_HIGH,
                NFDeviceConsts.SUME_NF_10G_INTERFACE1_BASEADDR,//XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_1_LOW,
                NFDeviceConsts.SUME_NF_10G_INTERFACE2_HIGHADDR,//XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_2_HIGH,
                NFDeviceConsts.SUME_NF_10G_INTERFACE2_BASEADDR,//XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_2_LOW,
                NFDeviceConsts.SUME_NF_10G_INTERFACE3_HIGHADDR,//XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_3_HIGH,
                NFDeviceConsts.SUME_NF_10G_INTERFACE3_BASEADDR//XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_3_LOW*/
        };
        ...
        addresses[0] = 0x74800044; //TODO NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_FILTER_IP;

        /* instantiate the ip table and add the listener */
/*commented        ipTableModel = new WideRegTableModel(nf2, addresses,
        ...
        ipTableModel.addTableModelListener(new TableModelListener() {
             ...
             */
            public void tableChanged(TableModelEvent e) {
/*commented                if(e.getFirstRow()>=NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_DST_IP_FILTER_TABLE_DEPTH-NUM_IFACES){
                    updateIPAddresses();
                    fireTableDataChanged();
                }*/
            }
