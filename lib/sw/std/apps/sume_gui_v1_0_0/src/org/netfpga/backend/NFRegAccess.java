...
public interface NFRegAccess extends Library {
	...
	NFRegAccess INSTANCE = (NFRegAccess) Native.loadLibrary ("sume", NFRegAccess.class);
	...
	public int regread(long reg);

	public int regread(IntByReference /*int*/ fd, int reg, IntByReference val);
	public int regwrite(int fd, int reg, int val);
