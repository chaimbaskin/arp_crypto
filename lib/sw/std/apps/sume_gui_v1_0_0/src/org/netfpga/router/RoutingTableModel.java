...
public class RoutingTableModel extends AbstractTableModel {
    ...
    public RoutingTableModel(NFDevice nf2){
        ...
        table = new Object[32/*NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_ROUTE_TABLE_DEPTH*/][COLUMN_NAMES.length];

        for(int i=0; i<32/*NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_ROUTE_TABLE_DEPTH*/; i++){
...
//commented        return NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_ROUTE_TABLE_DEPTH;
			return 32;
    }
