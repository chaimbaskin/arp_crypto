...
/*
  ...
  //      ifaceTableModel = new InterfacePortConfigTableModel(nf2);
    ...
    private void setupStatsTable(NFDevice nf2) {
        ...
        aAddresses[0] = NFDeviceConsts.SUME_NF_10G_INTERFACE_SHARED_0_PKTIN;//NFDeviceConsts.SUME_NF_10G_INTERFACE_SHARED_PKTIN_0;//XPAR_NF10_10G_INTERFACE_0_RX_ENQUEUED_PKTS; TODO  change

        aAddresses[1] = NFDeviceConsts.SUME_NF_10G_INTERFACE_1_PKTIN;//XPAR_NF10_10G_INTERFACE_1_RX_ENQUEUED_PKTS;

        aAddresses[2] = NFDeviceConsts.SUME_NF_10G_INTERFACE_2_PKTIN;//XPAR_NF10_10G_INTERFACE_2_RX_ENQUEUED_PKTS;
        aAddresses[3] = NFDeviceConsts.SUME_NF_10G_INTERFACE_3_PKTIN;//XPAR_NF10_10G_INTERFACE_3_RX_ENQUEUED_PKTS;

        aAddresses[4] = NFDeviceConsts.SUME_NF_10G_INTERFACE_SHARED_0_PKTOUT;//XPAR_NF10_10G_INTERFACE_0_TX_DEQUEUED_PKTS;
        aAddresses[5] = NFDeviceConsts.SUME_NF_10G_INTERFACE_1_PKTOUT;//XPAR_NF10_10G_INTERFACE_1_TX_DEQUEUED_PKTS;
        aAddresses[6] = NFDeviceConsts.SUME_NF_10G_INTERFACE_2_PKTOUT;//XPAR_NF10_10G_INTERFACE_2_TX_DEQUEUED_PKTS;
        aAddresses[7] = NFDeviceConsts.SUME_NF_10G_INTERFACE_3_PKTOUT;//XPAR_NF10_10G_INTERFACE_3_TX_DEQUEUED_PKTS;

        /* the MAC output queues are the even numbered queues */
/*TODO*/        aAddresses[8] = NFDeviceConsts.SUME_NF_10G_INTERFACE_SHARED_0_PCSPMASTATUSVECTOR12;//XPAR_NF10_10G_INTERFACE_0_RX_PKTS_DROPPED;
        aAddresses[9] = NFDeviceConsts.SUME_NF_10G_INTERFACE_1_PCSPMASTATUSVECTOR12;//XPAR_NF10_10G_INTERFACE_1_RX_PKTS_DROPPED;
        aAddresses[10] = NFDeviceConsts.SUME_NF_10G_INTERFACE_2_PCSPMASTATUSVECTOR12;//XPAR_NF10_10G_INTERFACE_2_RX_PKTS_DROPPED;
        aAddresses[11] = NFDeviceConsts.SUME_NF_10G_INTERFACE_3_PCSPMASTATUSVECTOR12;//XPAR_NF10_10G_INTERFACE_3_RX_PKTS_DROPPED;
        ...
        for(int i=0; i<STATS_NUM_REGS_USED; i++){
            statsRegTableModel.setDifferentialGraph(i, false);
        }
    }
    ...
    private void initComponents() {
        ...
        pktsRcvdChart0 = new BarGraphPanel("Port 0: Pkts Received", "Pkts Received", "time (sec)", "Number of Packets", 2000);
        pktsRcvdChart1 = new BarGraphPanel("Port 1: Pkts Received", "Pkts Received", "time (sec)", "Number of Packets", 2000);
        pktsRcvdChart2 = new BarGraphPanel("Port 2: Pkts Received", "Pkts Received", "time (sec)", "Number of Packets", 2000);
        pktsRcvdChart3 = new BarGraphPanel("Port 3: Pkts Received", "Pkts Received", "time (sec)", "Number of Packets", 2000);
        pktsSentChart0 = new BarGraphPanel("Port 0: Pkts Sent", "Pkts Sent", "time (sec)", "Number of Packets", 2000);
        pktsSentChart1 = new BarGraphPanel("Port 1: Pkts Sent", "Pkts Sent", "time (sec)", "Number of Packets", 2000);
        pktsSentChart2 = new BarGraphPanel("Port 2: Pkts Sent", "Pkts Sent", "time (sec)", "Number of Packets", 2000);
        pktsSentChart3 = new BarGraphPanel("Port 3: Pkts Sent", "Pkts Sent", "time (sec)", "Number of Packets", 2000);
        pktsDroppedChart0 = new BarGraphPanel("Port 0: Pkts Dropped", "Pkts Sent", "time (sec)", "Number of Packets", 2000);
        pktsDroppedChart0.setName("first chart");
        pktsDroppedChart1 = new BarGraphPanel("Port 1: Pkts Dropped", "Pkts Sent", "time (sec)", "Number of Packets", 2000);
        pktsDroppedChart2 = new BarGraphPanel("Port 2: Pkts Dropped", "Pkts Sent", "time (sec)", "Number of Packets", 2000);
        pktsDroppedChart3 = new BarGraphPanel("Port 3: Pkts Dropped", "Pkts Sent", "time (sec)", "Number of Packets", 2000);
            ...
            .add(routerConfigPaneLayout.createSequentialGroup()
                .add(routerConfigPaneLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, routerConfigPaneLayout.createSequentialGroup()
                        .add(12, 12, 12)/root/Documents/NetFPGA-SUME-dev-master/lib/sw/std/driver/sume_riffa_v1_0_0/nf_sume.h
