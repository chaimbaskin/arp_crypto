...
create_ip -name arp_crypto -vendor NetFPGA -library NetFPGA -module_name arp_crypto_ip
set_property generate_synth_checkpoint false [get_files arp_crypto_ip.xci]
reset_target all [get_ips arp_crypto_ip]
generate_target all [get_ips arp_crypto_ip]
