...
(
  ...
  //arp_arp_crypto module connectivity

     
    wire [C_M_AXIS_DATA_WIDTH - 1:0]         m_axis_arp_crypto_tdata;
    wire [((C_M_AXIS_DATA_WIDTH / 8)) - 1:0] m_axis_arp_crypto_tkeep;
    wire [C_M_AXIS_TUSER_WIDTH-1:0]          m_axis_arp_crypto_tuser;
    wire                                     m_axis_arp_crypto_tvalid;
    wire                                     m_axis_arp_crypto_tready;
    wire                                     m_axis_arp_crypto_tlast;
   ...
   output_port_lookup_1  (
    ...
    //arp_crypto_module #(
     ...
     arp_crypto  (
      .axis_aclk(axis_aclk), // input axi_aclk
      .axis_resetn(axis_resetn), // input axi_resetn
      .m_axis_tdata (m_axis_arp_crypto_tdata), // output [255 : 0] m_axis_tdata
      .m_axis_tkeep (m_axis_arp_crypto_tkeep), // output [31 : 0] m_axis_tkeep
      .m_axis_tuser (m_axis_arp_crypto_tuser), // output [127 : 0] m_axis_tuser
      .m_axis_tvalid(m_axis_arp_crypto_tvalid), // output m_axis_tvalid
      .m_axis_tready(m_axis_arp_crypto_tready), // input m_axis_tready
      .m_axis_tlast (m_axis_arp_crypto_tlast), // output m_axis_tlast
      ...
      .axis_aclk(axis_aclk), // input axi_aclk
      .axis_resetn(axis_resetn), // input axi_resetn
      .s_axis_tdata   (m_axis_arp_crypto_tdata), // input [255 : 0] s_axis_tdata
      .s_axis_tkeep   (m_axis_arp_crypto_tkeep), // input [31 : 0] s_axis_tkeep
      .s_axis_tuser   (m_axis_arp_crypto_tuser), // input [127 : 0] s_axis_tuser
      .s_axis_tvalid  (m_axis_arp_crypto_tvalid), // input s_axis_tvalid
      .s_axis_tready  (m_axis_arp_crypto_tready), // output s_axis_tready
      .s_axis_tlast   (m_axis_arp_crypto_tlast), // input s_axis_tlast
